...
for pat in patience:
    for sample in sample_out:
        for lr_ in lr:
                for ah in ahead:
                    if options.cnn:
                        save_model = f"cnn_disease_{options.disease}_weekahead_{ah}"
                        ...
                        save_model = f"rag_disease_{options.disease}_weekahead_{ah}"
                        print(f"Training {save_model}")
                        subprocess.run(
                            [
                                "python",
                        ...
                        save_model = f"normal_disease_{options.disease}_weekahead_{ah}"
                        print(f"Training {save_model}")
                        subprocess.run(
                            [
                                "python",
